...
> [!NOTE]
> ჩუბაკა არის ვარსკვლავური ომების პერსონაჟი. დიდად არ იფიქროთ ამ მაგალითზე. თუ ვერ გაიგეთ მაგალითი, ჩუბაკა შეცვალეთ დათვით. ჯიმის ნიკოტინზე დამოკიდებულება ვერ გამოვიყენე ამჯერად.
...
---
# round() ფუნქცია
round() ფუნქცია ჩვეულებრივ ამრგვალებს რიცხვს.
```python
print(round(3.4)) # დააბრუნებს 3-ს.
print(round(3.5)) # დააბრუნებს 4-ს.
```
